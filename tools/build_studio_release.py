...
MODULES = ('__init__', 'paths', 'platform_support', 'macos_support', 'macos_audio', 'secure_storage', 'startup', 'config', 'workstation_main',
           'studio_router', 'meeting_prompt', 'calendar_service', 'moodle_calendar', 'deadlines', 'gpa_tracker', 'habits', 'study_sessions', 'study_guide', 'updates', 'update_download', 'version',
...
GUI = ('__init__', 'design', 'meeting_window', 'studio_dock', 'week_calendar', 'study_timer', 'gpa_tracker', 'habit_tracker', 'studio_setup', 'moodle_setup', 'deadline_inbox', 'studio_updates', 'prayer_widget', 'prayer_card')
